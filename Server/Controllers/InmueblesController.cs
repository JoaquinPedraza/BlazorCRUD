...
namespace BlazorCRUD.Server.Controllers
{
    ...
    public class InmueblesController : ControllerBase
    {
        ...
        public InmueblesController(TrabajoFinalContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Inmuebles/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Inmueble>> GetInmueble(byte id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutInmueble(byte id, Inmueble inmueble)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteInmueble(byte id)
        {
            var inmueble = await _context.Inmuebles.FindAsync(id);
            if (inmueble == null)
            {
        ...
        private bool InmuebleExists(byte id)
        {
